const USERS = {
  ...
  export const TOP_PLACES = [
    {
      id: 1,
      image: require('../../assets/images/trips/seoulsunset.jpeg'),
      title: 'Seoul',
    ...
    {
      id: 4,
      image: require('../../assets/images/trips/paju1.jpeg'),
      title: 'Paju',
      location: 'Gyeonggi Province',
      description:
    ...
    {
      id: 6,
      image: require('../../assets/images/trips/jeju1.jpeg'),
      title: 'Jeju Island',
    ...
    {
        id: 13,
        image: require('../../assets/images/trips/busan1.jpeg'),
        title: 'Busan',
        location: 'Gyeongsang Province',
        description:
          "Cherry blossoms usually bloom between mid-March and early May. In 2022, Tokyo's cherry blossom season officially began on March 20",
        rating: 7.4,
        gallery: [],
      ...
      {
        id: 14,
        image: require('../../assets/images/trips/Gyeongju.jpeg'),
        title: 'Gyeongju',
        location: 'Gyeongsang Province',
        description:
          "Cherry blossoms usually bloom between mid-March and early May. In 2022, Tokyo's cherry blossom season officially began on March 20",
